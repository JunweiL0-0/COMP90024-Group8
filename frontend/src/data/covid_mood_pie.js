...
export default function PieChartCovid() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://172.26.131.106:8080/geo_tweet/_design/General/_view/cnt_covid_tweet_by_mood?group=true');
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
            <h1>Covid Related Sentiment Ratio</h1>

...
function MyTable() {
    ...
    const url = process.env.REACT_APP_URL+'/geo_tweet/_design/General/_view/cnt_variance_mood_by_gcc?group=true';
    ...
    return (
        <div style={{ display: 'flex', justifyContent: 'center' }}>
            <table {...getTableProps()} style={{ border: 'solid 1px black', textAlign: 'left' , width: '380px'}}>
                <thead>
